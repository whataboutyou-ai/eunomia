...
from eunomia.fetchers.base import BaseFetcherConfig
from .conftest import MockFetcher, MockFetcherConfig
...
class TestFetcherFactory:
    ...
    def test_register_fetcher_basic(self, clean_factory):
        ...
        FetcherFactory.register_fetcher(
            "test_fetcher", MockFetcher, MockFetcherConfig
        )
    ...
    def test_create_fetcher_invalid_config(self, clean_factory):
        ...
        fetcher = FetcherFactory.create_fetcher("test_fetcher", invalid_config)
        assert isinstance(fetcher, MockFetcher)
    ...
    def test_initialize_fetchers_with_router(self, clean_factory, mock_fetcher_config, router_factory):
    ...
    def test_initialize_multiple_fetchers(self, clean_factory):
        ...
        FetcherFactory.register_fetcher(
            "fetcher1", MockFetcher, MockFetcherConfig
        )
        FetcherFactory.register_fetcher(
            "fetcher2", MockFetcher, MockFetcherConfig
        )
    ...
    def test_get_fetcher_not_initialized(self, clean_factory):
        ...
        with pytest.raises(ValueError, match="Fetcher not initialized: unknown_fetcher"):
    ...
    def test_get_router_success(self, clean_factory, mock_fetcher_config, router_factory):
    ...
    def test_get_router_not_available(self, clean_factory, mock_fetcher_config):
        ...
        with pytest.raises(ValueError, match="Router not available for fetcher: test_fetcher"):
    ...
    def test_factory_isolation(self, clean_factory):
        ...
        FetcherFactory.register_fetcher(
            "other_fetcher", MockFetcher, MockFetcherConfig
        )
