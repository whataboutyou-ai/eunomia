...
class TestPassportJWT:
    ...
    def test_passport_jwt_missing_jti(self):
        ...
        assert any(error['loc'] == ('jti',) and error['type'] == 'missing' for error in errors)
    ...
    def test_passport_jwt_missing_sub(self):
        ...
        errors = exc_info.value.errors()
        assert any(error['loc'] == ('sub',) and error['type'] == 'missing' for error in errors)
...
class TestPassportIssueRequest:
    ...
    def test_issue_request_required_uri(self):
        ...
        errors = exc_info.value.errors()
        assert any(error['loc'] == ('uri',) and error['type'] == 'missing' for error in errors)
...
class TestPassportIssueResponse:
    ...
    def test_issue_response_missing_passport(self):
        ...
        errors = exc_info.value.errors()
        assert any(error['loc'] == ('passport',) and error['type'] == 'missing' for error in errors)
    ...
    def test_issue_response_missing_passport_id(self):
        ...
        errors = exc_info.value.errors()
        assert any(error['loc'] == ('passport_id',) and error['type'] == 'missing' for error in errors)
    ...
    def test_issue_response_missing_expires_in(self):
        ...
        errors = exc_info.value.errors()
        assert any(error['loc'] == ('expires_in',) and error['type'] == 'missing' for error in errors)
